            ...
            <?php echo form_open('register','id="registerForm" name="registerForm" onsubmit="return validateForm()" '); ?>
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <label for="xx_messenger"><?php echo display('your_xx_messenger_address_recommended_for_max_security') ?></label>
                        <input type="text" class="form-control" id="xx_messenger" name="xx_messenger" placeholder="XX Messenger Address">
                    </div>
                </div>
                <div class="d-flex justify-content-between mb-3">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="accept_terms" name="raccept_terms" value="ptConfirm" >
                        <label class="custom-control-label" for="accept_terms"> <?php echo display('the_filled_data_is_correct'); ?></label>
                    </div>
                </div>
