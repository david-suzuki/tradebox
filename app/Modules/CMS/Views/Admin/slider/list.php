            ...
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-right">
                        <div class="actions">
                            <a href="<?php echo base_url('backend/cms/add-slider'); ?>" class="btn btn-success w-md m-b-5 pull-right"><i class="fa fa-plus" aria-hidden="true"></i> Slider</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <table id="example" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url("backend/cms/edit-slider/$value->id") ?>" class="btn btn-info btn-sm" title="Update"><i class="hvr-buzz-out fas fa-pencil-alt"></i></a>
