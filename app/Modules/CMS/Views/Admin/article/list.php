    ...
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="text-right">
                <div class="actions">
                    <a href="<?php echo base_url('backend/cms/add-page-content'); ?>" class="btn btn-success w-md m-b-5 pull-right"><i class="fa fa-plus" aria-hidden="true"></i> Page Content</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?php echo base_url("backend/cms/delete-page-content/$value->article_id") ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-danger btn-sm" title="Delete "><i class="hvr-buzz-out fas fa-trash"></i></a>
                    </td>
                </tr>
                <?php $sl++; } } ?>
            </tbody>
