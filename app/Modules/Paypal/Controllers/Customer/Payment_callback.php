    ...
    public function paypal_confirm()
    {
        ...
        if (isset($_GET['paymentId']))
        {
            ...
            if ($gateway)
            {
                ...
                // After Step 1
                $apiContext = new \PayPal\Rest\ApiContext(new \PayPal\Auth\OAuthTokenCredential(@$gateway->public_key, // ClientID
                ...
                try
                {
                    ...
                    $subtotal = $payment->transactions[0]
                        ->related_resources[0]
                        ->sale
                        ->amount
                        ->details->subtotal;
                    ...
                    if ($result)
                    {
                        ...
                        elseif ($payment_type == 'buy')
                        {
                                ...
                                ->get('buy_save')))
                            {
                                ...
                                $this
                                    ->session
                                    ->setFlashdata('message', display('payment_successfully'));
                                return redirect()
                                    ->to(base_url('customer/buy/buy_list'));
                            }
                            else
                            {
                                $this
                                ...
                                return redirect()
                                    ->to(base_url('customer/buy/buy_form'));
                            }
                        }
