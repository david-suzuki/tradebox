<div class="card">
    ...
    <div class="card-body">
        <?php echo form_open_multipart(base_url("backend/user/edit-user/$user->id")); ?>
        ...
        <?php echo form_hidden('user_id', $user->user_id) ?>
            <div class="row">
                ...
                <div class="form-group col-lg-6">
                    <label class="font-weight-600"><?php echo display("xx_messenger") ?></label>
                    <input type="text" value="<?php echo esc($user->xx_messenger) ?>" id="xx_messenger" class="form-control" name="xx_messenger" placeholder="<?php echo display("xx_messenger") ?>">
                </div>
                <div class="form-group col-lg-6">
            ...
            <div>
                <a href="<?php echo base_url('backend/home'); ?>" class="btn btn-primary"><?php echo display("cancel") ?></a>
