                    ...
                    <table id="example" class="table table-bordered table-hover">
                        <thead>
                            <tr> 
                                ...
                                <th><?php echo display('custom_order') ?></th> 
                            </tr>
                        </thead>    
                        <tbody>
                            ...
                            <tr id="row-<?php echo $value->id; ?>">
                                ...
                                <td>
                                    <?php echo esc($value->order); ?>
                                    <button onclick="row_order(-1, <?php echo $value->id; ?>)" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="Up"><i class="hvr-buzz-out fas fa-angle-up"></i></button>
                                    <button onclick="row_order(1, <?php echo $value->id; ?>)" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="Down"><i class="hvr-buzz-out fas fa-angle-down"></i></button>
                                </td>
                            </tr>
                            <?php } ?>  
                        </tbody>
...
<script>
    function row_order(mode, id) {
        $.ajax({
            url: "<?php echo base_url("backend/exchange/row-order"); ?>",
            headers: {
