...
const s = class {
    constructor(o) {
        ...
        }), this._options.debug && (n || (n = !0, console.log("Using CL v21.066 (internal id 132c7060 @ 2022-04-01T09:59:44.647Z)"))), this._create()
    }
    onChartReady(e) {
...
window.TradingView = window.TradingView || {}, window.TradingView.version = o, exports.version = o, exports.widget = s;