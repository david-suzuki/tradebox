! function (e, t) {
    ...
    function t(e, i) {
        ...
        for (const o in i) "object" != typeof e[o] || null === e[o] || Array.isArray(e[o]) ? void 0 !== i[o] && (n[o] = i[o]) : n[o] = t(e[o], i[o]);
        return n
    }
    const i = {
            mobile: {
    ...
    const r = class {
        constructor(e) {
            ...
            }), this._options.debug && (o || (o = !0, console.log("Using CL v21.066 (internal id 132c7060 @ 2022-04-01T09:59:44.647Z)"))), this._create()
        }
        onChartReady(e) {
    ...
    window.TradingView = window.TradingView || {}, window.TradingView.version = s, e.version = s, e.widget = r, Object.defineProperty(e, "__esModule", {
        value: !0
    })
}));